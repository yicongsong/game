...
export class liwuopen extends Sprite {

    constructor(index,x,y,level) {
        let str = ['liwuopen1', 'liwuopen2', 'liwuopen3'];
        const image = Sprite.getImage(str[index]);
        super(image, 0, 0, image.width, image.height, x, y, image.width * 0.5, image.height * 0.5);
